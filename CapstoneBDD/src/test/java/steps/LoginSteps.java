...
public class LoginSteps {
	...
	public void user_has_opened_application() {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\atgore\\Downloads\\chromedriver_win32\\chromedriver.exe");
//	     WebDriver driver;
	...
	public void user_enters_details_required() {
		...
		//driver.findElement(By.name("email_id")).sendKeys("atgore@domain.com");
     	//driver.findElement(By.name("pwd")).sendKeys("atgore");
		//driver.findElement(By.name("pwd2")).sendKeys("atgore");
     	//driver.findElement(By.name("name")).sendKeys("atgore");
